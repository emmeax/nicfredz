...
const CPRTrainingSection = () => {
  return (
    <section className="font-cabinet font-bold w-full bg-white py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-16 md:mb-20">
        ...
        <div className="md:hidden">
          ...
          <div className="mb-6">
            <p
              className="text-gray-800 mb-2 font-normal"
            ...
            <p
              className="text-gray-800 mb-10 font-normal"
              style={{ textAlign: 'justify' }}
            >
          ...
          {/* Icons Row */}
          <div className="flex justify-between bg-white shadow-lg rounded-xl p-2 items-start gap-4">
            <div className="flex flex-col items-center text-center">
              <img src={caseMedical} alt="Emergency Training" className="w-8 mb-2" />
              <p className="font-semibold text-xs">Emergency Training</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <img src={HeartPulse} alt="Lifesaving Skills" className="w-8 mb-2" />
              <p className="font-semibold text-sm">Lifesaving Skills</p>
            </div>
            <div className="flex flex-col items-center text-center">
              <img src={Stethoscope} alt="CPR Certification" className="w-8 mb-2" />
        ...
        <div className="hidden md:grid grid-cols-2 gap-10 items-center relative">
          ...
          <div className="max-w-prose mb-10">
            ...
            <p
              className="text-gray-800 mb-22 font-normal"
              style={{ textAlign: 'justify' }}
            >
              We cover care for adults, children, and infants, with flexible training formats and same-day
              certification. Whether you're new or renewing, you’ll gain practical skills and the mindset to respond
        ...
        <div className="hidden md:block">
          <div className="-mt-12 ml-0 max-w-3xl bg-white shadow-lg rounded-xl p-6 grid grid-cols-3 gap-6 z-10 relative">
            <div className="flex flex-col items-center text-center">
