  ...
  return (
    <div className="relative font-cabinet w-full bg-white text-black md:text-white">
      ...
      <nav className="relative z-10 flex justify-between items-center px-6 py-4">
        <div className="flex items-center font-cabinet font-bold gap-2 text-xl font-bold">
          <img src={icon} alt="" className='mt-3 w-8 h-8' />
          MARINA MEDICALS
        </div>

        {/* Desktop Menu */}
        <ul className="hidden md:flex gap-8 text-lg font-medium ">
          <li className="cursor-pointer flex items-left gap-1">
          ...
          <li className="cursor-pointer flex items-center gap-1">
            <a href="#bookings" className="hover:text-purple-400 transition">Bookings</a>
          </li>
          <li className="cursor-pointer flex items-center gap-1">
            <a href="#contact" className="hover:text-purple-400  transition">Contact Us</a>
          </li>
        </ul>

        {/* Desktop Button */}
        <button className="hidden md:inline-block px-5 font-bold py-2 bg-purple-600 hover:bg-purple-700 rounded text-white text-sm font-medium">
          BOOK AN APPOINTMENT
        </button>
      ...
      {isOpen && (
        <div className="absolute top-16 right-1 z-20 bg-black/90 text-white p-2 rounded-lg space-y-4 text-center shadow-lg">
          ...
          <button className="mt-2 w-full px-4  font-bold py-2 bg-purple-600 hover:bg-purple-700 rounded text-white text-base font-semibold" onClick={toggleMenu}>
            BOOK AN APPOINTMENT
          </button>
        </div>
      )}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-[80%] md:h-screen text-center px-6 space-y-6 py-10 md:py-0">
        ...
        <button className="mt-4 px-6 py-3 font-bold bg-yellow-500 hover:bg-yellow-600 rounded text-black font-semibold">
          BOOK AN APPOINTMENT
        </button>
